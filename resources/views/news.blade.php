    ...
    <div class="container-xxl py-4 mb-5">
        <div class="container" id="sc-news">
            ...
            <div class="row justify-content-center align-items-center py-2">
                ...
                <div class="col-lg-auto mb-lg-0 mb-3">
                    <img src="{{ asset('assets/images/02/news_pic2.jpg') }}" class="img-fluid hp-news-pic" alt="">
                </div>
            ...
            <div class="row justify-content-center align-items-center py-2">
                ...
                <div class="col-lg-auto mb-lg-0 mb-3">
                    <img src="{{ asset('assets/images/02/news_pic3.jpg') }}" class="img-fluid hp-news-pic" alt="">
                </div>
            ...
            <div class="row justify-content-center align-items-center py-2">
                ...
                <div class="col-lg-auto mb-lg-0 mb-3">
                    <img src="{{ asset('assets/images/02/news_pic4.jpg') }}" class="img-fluid hp-news-pic" alt="">
                </div>
            ...
            <div class="row justify-content-center align-items-center py-2">
                ...
                <div class="col-lg-auto mb-lg-0 mb-3">
                    <img src="{{ asset('assets/images/02/news_pic5.jpg') }}" class="img-fluid hp-news-pic" alt="">
                </div>
            ...
            <div class="row justify-content-center align-items-center py-2">
                ...
                <div class="col-lg-auto mb-lg-0 mb-3">
                    <img src="{{ asset('assets/images/02/news_pic6.jpg') }}" class="img-fluid hp-news-pic" alt="">
                </div>

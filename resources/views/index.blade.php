                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="product-item-box">
                            ...
                            <div class="product-item-content">
                                ...
                                <a href="{{ route('products-details-mock') }}" class="product-item-more item-more-btn">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <p class="text-028cd3 font-weight-normal mb-0">MORE</p>
                                        <p class="text-028cd3 font-weight-normal mb-0">⟩</p>
                                    </div>
                ...
                @if (!isset($news))
                    ...
                    <div class="col-lg" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="d-flex flex-row justify-content-end align-items-center mt-3">
                            <a href="{{ route('news-details-mock') }}" class="news-more text-028cd3 font-weight-normal">了解更多 MORE ⟩</a>
                        </div>
